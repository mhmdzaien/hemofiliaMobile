              ...
              <View
                ...
                <View style={{marginHorizontal: 15, marginTop: 10}}>
                  ...
                  <Text
                    ...
                    terdekat untuk menyingkirkan kemungkinan menderita hemofilia
                    atau gangguan pendarahan lainnya. untuk pemeriksaan lebih
          ...
          <View style={{flexDirection: 'row', marginTop: 20}}>
            ...
            {this.props.route.params.nearbyHospital && (
              <View style={{marginHorizontal: 15, marginTop: 10}}>
                ...
                <RumahSakitCard data={this.props.route.params.nearbyHospital} />
              </View>
            )}
